...
% \begin{enumerate}
  ...
  The variance of $\sqrt{n}\tau$ is 
    ...
    special case given in the theorem. Expression \eqref{eqn:general variance} also gives a criterion for the direction of the bias, i.e., the sign of $2\E(\z F_\z(\z))-\E(f_\z(\z))$.
