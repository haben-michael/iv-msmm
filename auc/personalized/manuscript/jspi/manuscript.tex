...
% \doublespacing
\title{The Population and Personalized Areas Under the Receiving Operating Characteristic Curve}
...
\maketitle
\noindent\textsc{Abstract:} We consider two generalizations of the area under the receiving operating characteristic curve (``AUC''), a popular measure of discrimination, to accommodate
...
the population AUC is appropriate.
  ...
  % \begin{enumerate}
\citet{obuchowski1997} proposes a nonparametric, asymptotic estimator for the
...
inference. \citet{rosner1999} give a formula for the finite-sample variance under certain distributional assumptions. \citet{lee2005} discuss the asymptotic behavior of generalized U-statistics with clustered data, a class which includes the estimator for the population AUC discussed in \citet{obuchowski1997} and below. \citet{liu2005} suggest a bootstrap approach, provided the data follow a generalized linear model. \citet{toledano2003} summarizes techniques in use for analyzing clustered ROC curves. \citet{pearl2014} gives an overview of Simpson's paradox, an effect illustrated by the examples in Section \ref{section:examples} below, from the standpoint of causal inference. \citet{michael2019} analyzes population and personalized
...
The remainder of the article is as follows. In Section \ref{section:setting} we introduce the AUC and the two
...
\begin{figure}[!tbp]
  \centering
  % \subfloat[Bivariate normal model \eqref{model:binormal}]{\includegraphics[width=0.5\textwidth]{../sim/220813/a/220813.pdf}}
  \subfloat[Bivariate normal model \eqref{model:binormal}]{\includegraphics[width=0.5\textwidth]{220813a.pdf}}
  \hfill
  % \subfloat[Bivariate normal model with censoring \eqref{model:censored binormal}]{\includegraphics[width=0.5\textwidth]{../sim/220813/b/220813.pdf}}
